        ...
        <nav class="navbar navbar-static-top">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="search-box">
                        <a class="nav-link hidden-sm-down" href="/admin/javascript:void(0)"><i class="mdi mdi-magnify"></i></a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu animated flipInY">
                            ...
                            <!-- Menu Body -->
                            <li class="user-body">
                                <a class="dropdown-item" href="/admin/javascript:void(0)"><i class="ion ion-person"></i> My Profile</a>
                                <a class="dropdown-item" href="/admin/javascript:void(0)"><i class="ion ion-bag"></i> My Balance</a>
                                <a class="dropdown-item" href="/admin/javascript:void(0)"><i class="ion ion-email-unread"></i> Inbox</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/admin/javascript:void(0)"><i class="ion ion-settings"></i> Account Setting</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/admin/javascript:void(0)"><i class="ion-log-out"></i> Logout</a>
                                <div class="dropdown-divider"></div>
                                <div class="p-10"><a href="/admin/javascript:void(0)" class="btn btn-sm btn-rounded btn-success">View Profile</a></div>
                            </li>
                        </ul>
                    </li>
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/javascript:void()"><i class="fa fa-user mr-5"></i>My Profile </a></li>
                        <li><a href="/admin/javascript:void()"><i class="fa fa-money mr-5"></i>My Balance</a></li>
                        <li><a href="/admin/javascript:void()"><i class="fa fa-envelope-open mr-5"></i>Inbox</a></li>
                        <li><a href="/admin/javascript:void()"><i class="fa fa-cog mr-5"></i>Account Setting</a></li>
                        <li><a href="/admin/javascript:void()"><i class="fa fa-power-off mr-5"></i>Logout</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/layout_boxed.html"><i class="mdi mdi-toggle-switch-off"></i>Boxed</a></li>
                        <li><a href="/admin/pages/layout_fixed.html"><i class="mdi mdi-toggle-switch-off"></i>Fixed</a></li>
                        <li><a href="/admin/pages/layout_collapsed_sidebar.html"><i class="mdi mdi-toggle-switch-off"></i>Mini Sidebar</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/page_layout_inner_left_sidebar.html"><i class="mdi mdi-toggle-switch-off"></i>Inner Left Sidebar </a></li>
                        <li><a href="/admin/pages/page_layout_inner_right_sidebar.html"><i class="mdi mdi-toggle-switch-off"></i>Inner Right Sidebar </a></li>
                        <li><a href="/admin/pages/page_layout_inner_fixed_left_sidebar.html"><i class="mdi mdi-toggle-switch-off"></i>Inner Fixed Left Sidebar </a></li>
                        <li><a href="/admin/pages/page_layout_inner_fixed_right_sidebar.html"><i class="mdi mdi-toggle-switch-off"></i>Inner Fixed Right Sidebar </a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/mailbox_inbox.html"><i class="mdi mdi-toggle-switch-off"></i>Inbox</a></li>
                        <li><a href="/admin/pages/mailbox_compose.html"><i class="mdi mdi-toggle-switch-off"></i>Compose</a></li>
                        <li><a href="/admin/pages/mailbox_read_mail.html"><i class="mdi mdi-toggle-switch-off"></i>Read</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/contact_app_chat.html"><i class="mdi mdi-toggle-switch-off"></i>Chat app</a></li>
                        <li><a href="/admin/pages/contact_app.html"><i class="mdi mdi-toggle-switch-off"></i>Contact / Employee</a></li>
                        <li><a href="/admin/pages/contact_userlist_grid.html"><i class="mdi mdi-toggle-switch-off"></i>Userlist Grid</a></li>
                        <li><a href="/admin/pages/contact_userlist.html"><i class="mdi mdi-toggle-switch-off"></i>Userlist</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/extra_app_ticket.html"><i class="mdi mdi-toggle-switch-off"></i>Support Ticket</a></li>
                        <li><a href="/admin/pages/extra_calendar.html"><i class="mdi mdi-toggle-switch-off"></i>Calendar</a></li>
                        <li><a href="/admin/pages/extra_profile.html"><i class="mdi mdi-toggle-switch-off"></i>Profile</a></li>
                        <li><a href="/admin/pages/extra_taskboard.html"><i class="mdi mdi-toggle-switch-off"></i>Project DashBoard</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/icons_fontawesome.html"><i class="mdi mdi-toggle-switch-off"></i>Font Awesome</a></li>
                        <li><a href="/admin/pages/icons_glyphicons.html"><i class="mdi mdi-toggle-switch-off"></i>Glyphicons</a></li>
                        <li><a href="/admin/pages/icons_material.html"><i class="mdi mdi-toggle-switch-off"></i>Material Icons</a></li>
                        <li><a href="/admin/pages/icons_themify.html"><i class="mdi mdi-toggle-switch-off"></i>Themify Icons</a></li>
                        <li><a href="/admin/pages/icons_simpleline.html"><i class="mdi mdi-toggle-switch-off"></i>Simple Line Icons</a></li>
                        <li><a href="/admin/pages/icons_cryptocoins.html"><i class="mdi mdi-toggle-switch-off"></i>Cryptocoins Icons</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/component_bootstrap_switch.html"><i class="mdi mdi-toggle-switch-off"></i>Bootstrap Switch</a></li>
                        <li><a href="/admin/pages/component_date_paginator.html"><i class="mdi mdi-toggle-switch-off"></i>Date Paginator</a></li>
                        <li><a href="/admin/pages/component_media_advanced.html"><i class="mdi mdi-toggle-switch-off"></i>Advanced Medias</a></li>
                        <li><a href="/admin/pages/component_modals.html"><i class="mdi mdi-toggle-switch-off"></i>Modals</a></li>
                        <li><a href="/admin/pages/component_nestable.html"><i class="mdi mdi-toggle-switch-off"></i>Nestable</a></li>
                        <li><a href="/admin/pages/component_notification.html"><i class="mdi mdi-toggle-switch-off"></i>Notification</a></li>
                        <li><a href="/admin/pages/component_portlet_draggable.html"><i class="mdi mdi-toggle-switch-off"></i>Draggable Portlets</a></li>
                        <li><a href="/admin/pages/component_sweatalert.html"><i class="mdi mdi-toggle-switch-off"></i>Sweet Alert</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/box_cards.html"><i class="mdi mdi-toggle-switch-off"></i>User Card</a></li>
                        <li><a href="/admin/pages/box_advanced.html"><i class="mdi mdi-toggle-switch-off"></i>Advanced Card</a></li>
                        <li><a href="/admin/pages/box_basic.html"><i class="mdi mdi-toggle-switch-off"></i>Basic Card</a></li>
                        <li><a href="/admin/pages/box_color.html"><i class="mdi mdi-toggle-switch-off"></i>Card Color</a></li>
                        <li><a href="/admin/pages/box_group.html"><i class="mdi mdi-toggle-switch-off"></i>Card Group</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/widgets_blog.html"><i class="mdi mdi-toggle-switch-off"></i>Blog</a></li>
                        <li><a href="/admin/pages/widgets_chart.html"><i class="mdi mdi-toggle-switch-off"></i>Chart</a></li>
                        <li><a href="/admin/pages/widgets_list.html"><i class="mdi mdi-toggle-switch-off"></i>List</a></li>
                        <li><a href="/admin/pages/widgets_social.html"><i class="mdi mdi-toggle-switch-off"></i>Social</a></li>
                        <li><a href="/admin/pages/widgets_statistic.html"><i class="mdi mdi-toggle-switch-off"></i>Statistic</a></li>
                        <li><a href="/admin/pages/widgets_weather.html"><i class="mdi mdi-toggle-switch-off"></i>Weather</a></li>
                        <li><a href="/admin/pages/widgets.html"><i class="mdi mdi-toggle-switch-off"></i>Widgets</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/forms_advanced.html"><i class="mdi mdi-toggle-switch-off"></i>Advanced Elements</a></li>
                        <li><a href="/admin/pages/forms_code_editor.html"><i class="mdi mdi-toggle-switch-off"></i>Code Editor</a></li>
                        <li><a href="/admin/pages/forms_editor_markdown.html"><i class="mdi mdi-toggle-switch-off"></i>Markdown</a></li>
                        <li><a href="/admin/pages/forms_editors.html"><i class="mdi mdi-toggle-switch-off"></i>Editors</a></li>
                        <li><a href="/admin/pages/forms_validation.html"><i class="mdi mdi-toggle-switch-off"></i>Form Validation</a></li>
                        <li><a href="/admin/pages/forms_wizard.html"><i class="mdi mdi-toggle-switch-off"></i>Form Wizard</a></li>
                        <li><a href="/admin/pages/forms_general.html"><i class="mdi mdi-toggle-switch-off"></i>General Elements</a></li>
                        <li><a href="/admin/pages/forms_mask.html"><i class="mdi mdi-toggle-switch-off"></i>Formatter</a></li>
                        <li><a href="/admin/pages/forms_xeditable.html"><i class="mdi mdi-toggle-switch-off"></i>Xeditable Editor</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/tables_simple.html"><i class="mdi mdi-toggle-switch-off"></i>Simple tables</a></li>
                        <li><a href="/admin/pages/tables_data.html"><i class="mdi mdi-toggle-switch-off"></i>Data tables</a></li>
                        <li><a href="/admin/pages/tables_editable.html"><i class="mdi mdi-toggle-switch-off"></i>Editable Tables</a></li>
                        <li><a href="/admin/pages/tables_color.html"><i class="mdi mdi-toggle-switch-off"></i>Table Color</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/charts_chartjs.html"><i class="mdi mdi-toggle-switch-off"></i>ChartJS</a></li>
                        <li><a href="/admin/pages/charts_flot.html"><i class="mdi mdi-toggle-switch-off"></i>Flot</a></li>
                        <li><a href="/admin/pages/charts_inline.html"><i class="mdi mdi-toggle-switch-off"></i>Inline charts</a></li>
                        <li><a href="/admin/pages/charts_morris.html"><i class="mdi mdi-toggle-switch-off"></i>Morris</a></li>
                        <li><a href="/admin/pages/charts_peity.html"><i class="mdi mdi-toggle-switch-off"></i>Peity</a></li>
                        <li><a href="/admin/pages/charts_chartist.html"><i class="mdi mdi-toggle-switch-off"></i>Chartist</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="/admin/pages/email_index.html">
                        <i class="mdi mdi-email"></i>
                        <span>Emails</span>
                    </a>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/map_google.html"><i class="mdi mdi-toggle-switch-off"></i>Google Map</a></li>
                        <li><a href="/admin/pages/map_vector.html"><i class="mdi mdi-toggle-switch-off"></i>Vector Map</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/extension_fullscreen.html"><i class="mdi mdi-toggle-switch-off"></i>Fullscreen</a></li>
                        <li><a href="/admin/pages/extension_pace.html"><i class="mdi mdi-toggle-switch-off"></i>Pace</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/ecommerce_products.html"><i class="mdi mdi-toggle-switch-off"></i>Products</a></li>
                        <li><a href="/admin/pages/ecommerce_cart.html"><i class="mdi mdi-toggle-switch-off"></i>Products Cart</a></li>
                        <li><a href="/admin/pages/ecommerce_products_edit.html"><i class="mdi mdi-toggle-switch-off"></i>Products Edit</a></li>
                        <li><a href="/admin/pages/ecommerce_details.html"><i class="mdi mdi-toggle-switch-off"></i>Product Details</a></li>
                        <li><a href="/admin/pages/ecommerce_orders.html"><i class="mdi mdi-toggle-switch-off"></i>Product Orders</a></li>
                        <li><a href="/admin/pages/ecommerce_checkout.html"><i class="mdi mdi-toggle-switch-off"></i>Products Checkout</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/auth_login.html"><i class="mdi mdi-toggle-switch-off"></i>Login</a></li>
                        <li><a href="/admin/pages/auth_login2.html"><i class="mdi mdi-toggle-switch-off"></i>Login 2</a></li>
                        <li><a href="/admin/pages/auth_register.html"><i class="mdi mdi-toggle-switch-off"></i>Register</a></li>
                        <li><a href="/admin/pages/auth_register2.html"><i class="mdi mdi-toggle-switch-off"></i>Register 2</a></li>
                        <li><a href="/admin/pages/auth_lockscreen.html"><i class="mdi mdi-toggle-switch-off"></i>Lockscreen</a></li>
                        <li><a href="/admin/pages/auth_user_pass.html"><i class="mdi mdi-toggle-switch-off"></i>Recover password</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/invoice.html"><i class="mdi mdi-toggle-switch-off"></i>Invoice</a></li>
                        <li><a href="/admin/pages/invoicelist.html"><i class="mdi mdi-toggle-switch-off"></i>Invoice List</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/error_400.html"><i class="mdi mdi-toggle-switch-off"></i>Error 400</a></li>
                        <li><a href="/admin/pages/error_403.html"><i class="mdi mdi-toggle-switch-off"></i>Error 403</a></li>
                        <li><a href="/admin/pages/error_404.html"><i class="mdi mdi-toggle-switch-off"></i>Error 404</a></li>
                        <li><a href="/admin/pages/error_500.html"><i class="mdi mdi-toggle-switch-off"></i>Error 500</a></li>
                        <li><a href="/admin/pages/error_503.html"><i class="mdi mdi-toggle-switch-off"></i>Error 503</a></li>
                        <li><a href="/admin/pages/error_maintenance.html"><i class="mdi mdi-toggle-switch-off"></i>Maintenance</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/pages/sample_blank.html"><i class="mdi mdi-toggle-switch-off"></i>Blank</a></li>
                        <li><a href="/admin/pages/sample_coming_soon.html"><i class="mdi mdi-toggle-switch-off"></i>Coming Soon</a></li>
                        <li><a href="/admin/pages/sample_custom_scroll.html"><i class="mdi mdi-toggle-switch-off"></i>Custom Scrolls</a></li>
                        <li><a href="/admin/pages/sample_faq.html"><i class="mdi mdi-toggle-switch-off"></i>FAQ</a></li>
                        <li><a href="/admin/pages/sample_gallery.html"><i class="mdi mdi-toggle-switch-off"></i>Gallery</a></li>
                        <li><a href="/admin/pages/sample_lightbox.html"><i class="mdi mdi-toggle-switch-off"></i>Lightbox Popup</a></li>
                        <li><a href="/admin/pages/sample_pricing.html"><i class="mdi mdi-toggle-switch-off"></i>Pricing</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                ...
                <li>
                    <a href="/admin/pages/auth_login.html">
        ...
        <section class="content">
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="row">
                        <div class="col-12">
                            <div class="box bg-img box-inverse" style="background-image: url(/admin/images/gallery/full/10.jpg);" data-overlay="7">
    ...
    <footer class="main-footer">
        <div class="pull-right d-none d-sm-inline-block">
            <ul class="nav nav-primary nav-dotted nav-dot-separated justify-content-center justify-content-md-end">
                <li class="nav-item">
                    <a class="nav-link" href="/admin/javascript:void(0)">FAQ</a>
                </li>
                <li class="nav-item">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="control-sidebar-home-tab">
                ...
                <ul class="control-sidebar-menu">
                    <li>
                        <a href="/admin/javascript:void(0)">
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        <label class="control-sidebar-subheading">
                            <a href="/admin/javascript:void(0)" class="text-red margin-r-5"><i class="fa fa-trash-o"></i></a>
                            Delete chat history
                        </label>
                    </div>
                    <!-- /.form-group -->
